...
<tr valign="top">
	<td colspan="2" style="padding:0px;">
		<h3 style="margin-bottom:5px;"><?php _e('Enable Nested Pages for:', 'nestedpages'); ?></h3>
	</td>
</tr>
<tr valign="top">
	<td colspan="2" style="padding:0;">
		<table width="100%" class="nestedpages-settings-table">
			<thead>
				...
				<th><?php _e('Enable', 'nestedpages'); ?></th>
			</thead>
			...
			<tr>
				...
				<td>
					<input type="checkbox" name="nestedpages_posttypes[]" value="<?php echo $type->name; ?>" />
				</td>
			</tr>
			<?php endforeach; ?>
		</table>
