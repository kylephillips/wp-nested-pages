...
<tr valign="top">
	<td colspan="2" style="padding:10px 0px;">
		...
		<p style="font-style:oblique;font-size:13px;">
			**<?php _e('<strong>Important:</strong> Changing page structures on live sites may effect SEO and existing inbound links. Limit structure changes by disabling nesting. Sorting within the current nesting structure will still be available. If nesting changes are made to a live site, it may help to add a 301 redirect to the new location.', 'nestedpages'); ?>
		</p>
	</td>
</tr>