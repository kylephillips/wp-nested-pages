<div class="wrap">
	...
	<h2 class="nav-tab-wrapper">
		...
		<a class="nav-tab <?php if ( $tab == 'posttype' ) echo 'nav-tab-active'; ?>" href="options-general.php?page=nested-pages-settings&tab=posttypes"><?php _e('Post Types', 'nestedpages'); ?></a>
	</h2>
